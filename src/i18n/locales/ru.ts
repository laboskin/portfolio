export const ru = {
  ...
  contact: {
    ...
    description:
      'В данный момент я нахожусь в поиске работы. Я готов рассмотреть все варианты, включая удалённую работу и релокацию в другой город или страну. Буду рад ответить на любые ваши вопросы.',
    button: 'Написать мне',
  },
  months: {
    january: 'Января',
